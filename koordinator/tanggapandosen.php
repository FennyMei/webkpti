...
<div class="container-contact100">
 ...
 <div id="download">
      <form class="contact100-form validate-form" method="POST" action="adddosen.php" enctype="multipart/form-data">
        <div class="wrap-input100 validate-input bg1" data-validate="Harap masukkan email">
          <span class="label-input100">Email</span>
          <input class="input100" type="email" name="dosen_pembimbing" placeholder="Masukkan email">
        </div>
        ...
        <input class="contact100-form-btn" type="submit" value="Ajukan" name="submit" onSubmit="return confirmation();">
       </form>
